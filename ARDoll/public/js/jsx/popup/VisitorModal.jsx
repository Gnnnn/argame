...
import {closeUserModal} from '../../actions/client';
...
const VisitorModal = React.createClass({
    displayName: 'VisitorModal',
    mixins     : [ReactPureRenderMixin],
    afterOpenFn() {},
    handleClose() {
        this.props.closeVisitorModal();
    },
    render() {
        ...
        return (
            <Modal isOpen = {isActive} onAfterOpen = {this.afterOpenFn} modalName = "VisitorModal"
                   style = {customStyles}>
                <div className = "row">
